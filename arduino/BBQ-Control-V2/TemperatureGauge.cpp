...
void TemperatureGauge::draw(Widgets&w,float core,float target,bool valid){
 ...
 w.centered(240,216,valid?"Meater verbunden":"Warte auf Messung",SmallFont,valid?Theme::Green:Theme::Orange);
 w.present();
}
